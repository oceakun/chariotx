...
type LocationServiceClient interface {
	SendLocation(ctx context.Context, in *LocationData, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *locationServiceClient) SendLocation(ctx context.Context, in *LocationData, opts ...grpc.CallOption) (*Ack, error) {
...
type LocationServiceServer interface {
	SendLocation(context.Context, *LocationData) (*Ack, error)
...
func (UnimplementedLocationServiceServer) SendLocation(context.Context, *LocationData) (*Ack, error) {
...
func _LocationService_SendLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).SendLocation(ctx, req.(*LocationData))
	}
